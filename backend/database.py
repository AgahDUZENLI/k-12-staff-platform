...
def seed_db():
    ...
    cur.execute("""INSERT INTO observations (teacher_id, observer_id, observed_at, observation_type, framework, course_name, room, scores, section_notes, raw_notes, flagged, status) VALUES
    ...
    # ── Performance Reviews ────────────────────────────────────────────────────
    cur.execute("""
        INSERT INTO performance_reviews (teacher_id, reviewer_id, period, category_scores, final_notes, status) VALUES
